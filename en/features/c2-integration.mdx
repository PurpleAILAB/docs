...
C2 frameworks are swappable via Docker Compose profiles. The current release supports Sliver, with the architecture designed for additional frameworks:

```bash
# Sliver C2
COMPOSE_PROFILES=c2-sliver decepticon

# Future: additional C2 frameworks via profiles
