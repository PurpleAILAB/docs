...
<CardGroup cols={2}>
  ...
  <Card title="스킬" icon="book-open">
    스킬 라이브러리에 새로운 오펜시브 기법 추가 — MITRE ATT&CK ID 태그, 킬 체인 단계별 구성.
  </Card>
...
<Steps>
  ...
  <Step title="명확한 커밋 메시지 작성">
    *무엇*을 했는지가 아닌 *왜* 했는지를 설명하는 명확하고 설명적인 커밋 메시지를 작성합니다.
  </Step>
...
- **프론트매터** — 이름, 설명, MITRE ATT&CK 기법 ID, 킬 체인 단계, 필요 도구
